...
export default class FilQue5 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FilQue4')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}> Which city hosts Bollywood ?</Text>
      </View>
