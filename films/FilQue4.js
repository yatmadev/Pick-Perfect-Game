...
export default class FilQue4 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FilQue3')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Name the director of the film 'The Shawshank Redemption'.</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('FilQue5')}>
