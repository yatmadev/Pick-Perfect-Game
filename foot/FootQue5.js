...
export default class FootQue5 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FootQue4')}/>
      </Left>
      <Body>
      ...
      <Right>
    	...
    	<Text style={styles.design}>Who is the top goal scorer of all time ?</Text>
    	</View>
