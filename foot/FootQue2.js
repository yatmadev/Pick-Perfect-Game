...
export default class FootQue2 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FootQue1')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>When was the first FIFA World Cup inaugurated ?</Text>
      </View>
