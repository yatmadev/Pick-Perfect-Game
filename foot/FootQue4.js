...
export default class FootQue4 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FootQue3')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.header}>Question 4:</Text>
      </View>

      <View style={styles.ques}>
      <Text style={styles.design}>When was first official international football match was played ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('FootQue5')}>
