...
export default class FootQue3 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('FootQue2')}/>
      </Left>
      <Body>
            <Title style={{color: 'black', justifyContent:'center',paddingLeft: 51, fontWeight: 'bold'}}>FOOTBALL</Title>
          </Body>
      <Right>
      ...
      <Text style={styles.design}>Which of the following country hosted the first Football World Cup ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('FootQue4')}>
