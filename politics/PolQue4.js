...
export default class PolQue4 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('PolQue3')}/>
      </Left>
      <Body>
            <Title style={{color: 'black', justifyContent:'center',paddingLeft: 51, fontWeight: 'bold'}}>POLITICS</Title>
          </Body>
      <Right>
      ...
      <Text style={styles.design}>The minimum age to qualify for election to the Lok Sabha is</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('PolQue5')}>
