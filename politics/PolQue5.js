...
export default class PolQue5 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('PolQue4')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Who is the current Prime Minister of India ?</Text>
      </View>
