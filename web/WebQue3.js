...
export default class WebQue3 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('WebQue2')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Who played the role of 'Bunty' in sacred games ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('WebQue4')}>
