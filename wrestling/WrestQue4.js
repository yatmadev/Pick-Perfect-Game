...
export default class WrestQue4 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('WrestQue3')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>The First Royal Rumble Took Place In Which Year ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('WrestQue5')}>
