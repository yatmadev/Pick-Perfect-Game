...
export default class WrestQue2 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('WrestQue1')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>How Many WrestleMania Matches Did Steve Austin Have ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('WrestQue3')}>
