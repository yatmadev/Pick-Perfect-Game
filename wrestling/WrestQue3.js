...
export default class WrestQue3 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('WrestQue2')}/>
      </Left>
      <Body>
            <Title style={{color: 'black', justifyContent:'center',paddingLeft: 40, fontWeight: 'bold'}}>WRESTLING</Title>
          </Body>
      <Right>
      ...
      <Text style={styles.header}>Question 3:</Text>
      </View>

      <View style={styles.ques}>
      <Text style={styles.design}>At What Event Did The Undertaker Debut ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('WrestQue4')}>
