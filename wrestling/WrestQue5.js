...
export default class WrestQue5 extends React.Component {
  state={
    selectedLang:0
  }
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('WrestQue4')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>What does WWE stand for ?</Text>
      </View>
        ...
        <View style={styles.item2}>
            ...
            <Text style={
              ...
              >WORLD WRESTLING ENTERTAINMENT</Text>
        </View>
