...
export default class Question5 extends React.Component {
  ...
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('Question4')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Who is the captain of the 2019 England cricket team ?</Text>
      </View>
