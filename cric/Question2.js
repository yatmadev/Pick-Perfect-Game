...
export default class Question2 extends React.Component {
  ...
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('Cricket')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Which cricket team has won most ICC Cricket World Cup titles ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('Question3')}>
