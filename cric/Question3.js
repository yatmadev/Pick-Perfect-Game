...
export default class Question3 extends React.Component {
  ...
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('Question2')}/>
      </Left>
      <Body>
      ...
      <Text style={styles.design}>Which cricket team has won most IPL titles ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('Question4')}>
