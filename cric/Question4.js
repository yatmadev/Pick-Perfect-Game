...
export default class Question4 extends React.Component {
  ...
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      <Left >
      <Icon name="md-arrow-round-back" onPress={()=>this.props.navigation.navigate('Question3')}/>
      </Left>
      <Body>
            <Title style={{color: 'black', justifyContent:'center',paddingLeft: 51, fontWeight: 'bold'}}>CRICKET</Title>
          </Body>
      <Right>
      ...
      <Text style={styles.design}>Who did England beat in the final of the 2019 Cricket World Cup ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('Question5')}>
