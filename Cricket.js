...
export default class Cricket extends React.Component {
  ...
  render(){
    ...
    <Header style={{justifyContent: 'flex-start', paddingRight: 7, backgroundColor: '#add8e6' }}>
      ...
      <Text style={styles.design}>Which team won the very first world cup tournament ?</Text>
      </View>
     ...
     <TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate('Question2')}>
